...
const SATISFYING_TYPES: Record<string, string[]> = {
  ...
  'ISLAY_SCOTCH':   ['ISLAY_SCOTCH'],
  'IRISH_WHISKEY':  ['IRISH_WHISKEY'],
  'CANADIAN_WHISKY':['CANADIAN_WHISKY'],
  ...
  'RUM_DARK':       ['RUM_DARK', 'RUM_AGED'],
  'RUM_AGED':       ['RUM_AGED', 'RUM_DARK'],
  'RUM_OVERPROOF':  ['RUM_OVERPROOF'],
  'RHUM_AGRICOLE':  ['RHUM_AGRICOLE'],
  ...
  'CHERRY_BRANDY':  ['CHERRY_BRANDY', 'CHERRY_LIQUEUR'],
  'PISCO':          ['PISCO'],
  'CACHACA':        ['CACHACA'],
  ...
  'PEYCHAUDS_BITTERS':['PEYCHAUDS_BITTERS'],
